(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider")) new core(".swiper", {
            ...
            if (document.querySelector(".slider-mobile")) new core(".swiper", {
                modules: [ Pagination, Lazy ],
                slidesPerView: auto,
                spaceBetween: 12,
                speed: 800,
                ...
                init: true,
                pagination: {
                    el: ".slider-mobile__pagination .swiper-pagination",
                    clickable: true
                },
                breakpoints: {
                    768: {
        ...
        for (let i = 0; i < likeBtnArray.length; i++) if (likeBtn) likeBtnArray[i].addEventListener("click", (function(e) {
            e.preventDefault();
